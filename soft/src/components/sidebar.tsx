...
export const SidebarDemo = ({children}: dashboardprop) => {
  ...
  return (
    <div
      className={cn(
        "flex flex-col md:flex-row bg-gray-100 dark:bg-neutral-800 flex-grow-1 border border-neutral-200 dark:border-neutral-700 overflow-hidden",
...
const Dashboard = ({children}:  dashboardprop) => {
  return ( 
