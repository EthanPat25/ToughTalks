...
export function EmblaCarousel({close}:any) {
  ...
  const updateSlidesInView = React.useCallback((emblaapi: EmblaCarouselType) => {
    console.log("updateSlidesInView called");
    setSlidesInView((slidesInView) => {
      console.log("Current slidesInView:", slidesInView); // Debug current state
      console.log("Currently visible slides:", emblaapi.slidesInView()); // Debug Embla API output
